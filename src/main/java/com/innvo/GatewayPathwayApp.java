...
@EnableZuulProxy
public class GatewayPathwayApp {

    private static final Logger log = LoggerFactory.getLogger(GatewayPathwayApp.class);

    private final Environment env;

    public GatewayPathwayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes gateway_pathway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(GatewayPathwayApp.class);
