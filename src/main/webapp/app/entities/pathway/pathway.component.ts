...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/pathway'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: Pathway) {
        return item.id;
    }
    registerChangeInPathways() {
        this.eventSubscriber = this.eventManager.subscribe('pathwayListModification', (response) => this.loadAll());
    }
