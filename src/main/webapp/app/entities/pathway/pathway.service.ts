...
export class PathwayService {
    ...
    create(pathway: Pathway): Observable<Pathway> {
        const copy = this.convert(pathway);
    ...
    update(pathway: Pathway): Observable<Pathway> {
        const copy = this.convert(pathway);
    ...
    private convert(pathway: Pathway): Pathway {
        const copy: Pathway = Object.assign({}, pathway);

        copy.lastmodifieddatetime = this.dateUtils.toDate(pathway.lastmodifieddatetime);
        return copy;
    }
}
